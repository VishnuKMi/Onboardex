      ...
      <div className='grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4'>
        <div>
          ...
          <p className='font-normal text-base leading-6 text-gray-600 mt-6'>
            Onboardex was founded with a vision to reshape the future of
            commerce. Our journey began with the belief that innovation knows no
            boundaries.
          </p>
        </div>
        <div>
          ...
          <p className='font-normal text-base leading-6 text-gray-600 mt-6'>
            We are rapidly expanding our reach to a thriving audience, enhancing
            their commerce experiences and driving success in every transaction
          </p>
        </div>
        <div className='sm:block hidden'>
          ...
          <p className='font-normal text-base leading-6 text-gray-600 mt-6'>
            Join us on this exciting journey as we shape the future of commerce
            together!
          </p>
        </div>
      </div>
